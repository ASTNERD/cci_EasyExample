...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(100), WORD(200)
	...
	ID(Macro_3), TYPEID_MACRO, WORD(8),
		CMD_CONTROL_AUDIO_DEVICE, 6, WORD(440), WORD(600), WORD(100)
	...
	ID(Macro_5), TYPEID_MACRO, WORD(16),
		CMD_HIDE_SHOW, ID(Container_Tageszaehler), False, 0xFF, 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 1, WORD(440), WORD(100), WORD(0)
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(S2, 401, 10),
		XYREF(Ein_Aus, 402, 101),
	ID(Seite_2), TYPEID_DATAMASK, COLOR(184), ID(ID_NULL), 2, 0, 
		XYREF(Button_S1, 379, 21),
		XYREF(Button_signal, 130, 132),
	...
	ID(S2), TYPEID_BUTTON, WORD(73), WORD(79), 82, 0, 1, 0, 1, 1, 
		XYREF(OutputString_Seite2, -4, 19),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_S1), TYPEID_BUTTON, WORD(69), WORD(60), 11, 0, 1, 0, 1, 1, 
		XYREF(OutputString_Seite1, -4, 16),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_signal), TYPEID_BUTTON, WORD(188), WORD(153), 12, 0, 1, 0, 1, 1, 
		XYREF(OutputString_Signal, -4, 63),
		MACRO(EV_KEYRELEASE, Macro_3),
	ID(Ein_Aus), TYPEID_BUTTON, WORD(70), WORD(83), 251, 0, 1, 0, 1, 2, 
		XYREF(OutputString_11008, -4, 28),
	...
	ID(OutputString_Seite2), TYPEID_OUTSTR, WORD(56), WORD(14), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_Seite1), TYPEID_OUTSTR, WORD(69), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '1', ' ', ' ', 0,
	ID(OutputString_Signal), TYPEID_OUTSTR, WORD(188), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'S', 'i', 'g', 'n', 'a', 'l', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(70), WORD(20), COLOR_BLACK, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(7), 'E', 'i', 'n', '/', 'A', 'u', 's', 0,
